    ...
    <g:if test="${metadata.contentType == 'text/html'}">
        ...
        $(document).ready(function() {
          $('#preview').load(function(){
            ...
            $head.append('<link
                href="${resource(dir: 'less', file: 'crm-ui-bootstrap.less.css', plugin: 'crm-ui-bootstrap')}"
                rel="stylesheet" type="text/css"/>');
            $head.append('<link
                href="${resource(dir: 'less', file: 'responsive.less.css', plugin: 'twitter-bootstrap')}"
                rel="stylesheet" type="text/css"/>');
            <% if (css) { %>
...
<div class="tabbable">
    ...
    <div class="tab-content">
            ...
            <g:uploadForm>
                ...
                <div class="form-actions">
                    ...
                    <g:if test="${params.referer}">
                        <crm:button type="url" href="${params.referer}" label="crmContent.button.back.label"
                                    icon="icon-remove"/>
                    </g:if>
        ...
        <div class="tab-pane" id="files">
            <tmpl:embedded view="${[id: 'files']}" bean="${crmResourceRef}" list="${children}"
